								...
								<div id="basic" class="col s12 active search_filters">
									<form onsubmit="return false;" onkeypress="return event.keyCode != 13;">
										<div class="row">
                                            ...
                                            ?>
											<div class="col s12 m3 valign-wrapper dt_hm_filtr_loc">
                                                ...
                                                <select id="my_country" name="my_country" searchable="<?php echo __( 'Search your Country' );?>" data-country="<?php echo $profile->country;?>" <?php if( $profile->show_me_to == $profile->country || $profile->show_me_to === '') {?>disabled="disabled"<?php }?>>
                                                    ...
                                                    <?php
                                                        ...
                                                        foreach( Dataset::load('countries') as $key => $val ){
                                                            echo '<option value="'. $key .'" data-code="'. $val['isd'] .'"  '. ( (  $my_country == $key  ) ? '' : '' ) . ' ' . ( (  $profile->country == $key  ) ? 'data-country="true"' : 'data-country="false"' ) .'>'. $val['name'] .'</option>';
                                                        }
                                                    ?>
                                                </select>
												...
												<div class="col s12 m3 tooltip_ajax">
												    <select id="city" searchable="<?php echo __( 'Search your city' );?>" name="city" data-city="<?php echo $profile->city;?>" <?php if( $profile->show_me_to == $profile->country || $profile->show_me_to === '') {?>disabled="disabled"<?php }?>>
                                                    <option value="" disabled selected><?php echo __( 'Choose your city' );?></option>
                                                   
                                                </select>
                                                <span class="tooltiptext_ajax">Please wait..</span>
												    </div>
                                            <?php } ?>
											<div class="col s12 m2">
