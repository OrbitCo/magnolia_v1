<?php
    foreach ($data['jsfiles'] as $key => $js_file) {
        echo '<script src="'. $theme_url . $js_file . '?'.time(). '" type="text/javascript" id="' . $key . '"/></script>';
    }
    // echo '<script src="'. $theme_url .'assets/js/materializeselect.js" type="text/javascript"></script>';
