...
<div class="container">
    <div class="dt_settings row">
        ...
        <form method="POST" action="/profile/save_general_setting" class="col s12 m6">
            ...
            <div class="row">
                <div class="input-field col s6 xs12">
                    <select id="country" name="country" searchable="<?php echo __( 'Search your Country' );?>">
                ...
                <div class="input-field col s6 xs12 tooltip_ajax">
                    <select id="city" name="city" searchable="<?php echo __( 'Search your city' );?>">
...
<script>
    $(document).ready(function(){
        ...
        $('#country').val(window.country).change().formSelect();
    });
</script>