                        ...
                        <div class="slider">
                            ...
                            <form class="slider-form slider-two">
                                ...
                                <div class="row">
                                    ...
                                    <div class="input-field col s6 tooltip_ajax">
                                        <select id="city" name="city" searchable="<?php echo __( 'Search your city' );?>"  data-errmsg="<?php echo __( 'Select your city.');?>" required>
