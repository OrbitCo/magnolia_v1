...
//        }
        ...
        if ($error == '') {
            $sql = 'SELECT `id`,`online`,`lastseen`,`username`,`avater`,`country`,`cities_name`,`first_name`,`last_name`,`location`,`birthday`,`language`,`relationship`,`height`,`body`,`smoke`,`ethnicity`,`pets`,`gender` FROM `users` ';
            $sql .= ' WHERE  ';
...
//            }
            ...
            foreach ($match_users as $key => $value) {
                ...
                $user->cities_name = $value['cities_name'];
