...
function udetails($user){
    ...
    if($user->cities_name!=''||$user->cities_name!=null)
    {
        if($return !== ''){
            $return .= ',';
        }
        $return .= '&nbsp;'.$user->cities_name;
    }
    if($country !== ''){
        if($return !== ''){
            $return .= ',';
...
function GetFindMatcheQuery($user_id, $limit, $offset, $country = true,$search = false){
    ...
    if(empty($u->show_me_to)){
     ...
     if($mycountry == $u->country && isset($_POST['city'])&& !empty($_POST['city']))
    {
        $dist_query = ' AND `country` = "' . $mycountry . '" AND `cities` = ' . $_POST['city'] . ' ';
    } else if ($mycountry == $u->country) {
    ...
    } else if($mycountry != $u->country && isset($_POST['city'])&& !empty($_POST['city'])) {
